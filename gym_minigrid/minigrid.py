...
class MiniGridEnv(gym.Env):
    ...
    def __init__(
        ...
        #print("\n\n\n\n**************secondself.observation_space ", self.observation_space)
    ...
    def _reward(self):
        ...
        """
        #print("it returned a non zero reward", 1 - 0.9 * (self.step_count / self.max_steps))
